...
# class FaZhaView(View):
#     template_name = 'accounts/fa-zha-1.html'

def FaZhaView_1(request):
    return render(request, 'data/fa-zha/fazha_1.html')


def FaZhaView_2(request):
    return render(request, 'data/fa-zha/fazha_2.html')


def FaZhaView_3(request):
    return render(request, 'data/fa-zha/fazha_3.html')


def FaZhaView_4(request):
    return render(request, 'data/fa-zha/fazha_4.html')
